...
class AttitudeController():
    def __init__(self):
        ...
        self.pose_subscriber = rospy.Subscriber("/rov/ms5837_filtered", Odometry, self.input_real_pose)
    ...
    def input_position(self,msg):
        self.error_pos = numpy.array([[self.reference_position[0,0]-msg.pose.pose.position.x],[self.reference_position[1,0]-msg.pose.pose.position.y],[self.reference_position[2,0]-(-1 * msg.pose.pose.position.z)]])
        # print("Error Pos: ")
    ...
    def publish_wrench(self):
        ...
        message.wrench.torque.z = 0 #-1 * self.command_torque[2,0]
        # Publish wrench
